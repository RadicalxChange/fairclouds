...
<button {...$trigger} use:trigger class="icon-button">
...
{#if $open}
  <div {...$portalled} use:portalled>
    ...
    <div
      class="absolute flex flex-col rounded-default top-20 right-4 z-50 h-full max-h-[calc(100vh-175px)] w-full max-w-[350px] bg-primary shadow-cloud p-7 pb-1 focus:outline-none"
      {...$content}
      use:content
    >
      ...
      <form class="flex flex-col gap-4">
        ...
        <label class="flex gap-2.5 items-center cursor-pointer justify-between">
                ...
                <ul>
                  <li>
                    <details>
                      ...
                      <img
                        src={`https://cms.fairclouds.life/assets/${drawing.image}`}
                        alt=""
                      />
                    </details>
                  </li>
